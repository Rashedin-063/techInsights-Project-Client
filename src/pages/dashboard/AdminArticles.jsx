...
const AdminArticles = () => {
  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-28 mx-8 md:mx-4 mt-20'>
        {articles?.map(article => <AdminArticleCard key={article._id} article={article} refetch={refetch}/>)}
    </div>
    </div>
  );
};
