  ...
  return (
    <div className='max-w-2xl px-8 py-4 rounded-lg shadow-xl border-2 border-deep-ocean border-dotted hover:transition-all hover:border-green-lantern hover:duration-300 rounded-ss-3xl rounded-ee-3xl group'>
      ...
      <div className='flex items-center justify-between mt-4'>
        <Link className='text-deep-ocean font-semibold hover:underline '>
          Read more
        </Link>

        <div className='flex items-center'>
          <button className='font-semibold  cursor-pointer border-2 border-deep-ocean px-2 border-opacity-45 rounded-lg hover:border-opacity-100 font-m-plus'>
            Make Premium
          </button>
        </div>
      </div>
